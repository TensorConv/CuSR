...
%   the whole solve as one kernel would contradict the roofline finding (sec 5E:
%   bound by host-orchestration + per-iter H<->D copies, not compute/bandwidth).
%
...
% H<->D boundary (the roofline overhead hook)
